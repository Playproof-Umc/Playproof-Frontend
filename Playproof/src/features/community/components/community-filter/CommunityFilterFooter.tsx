...
export function CommunityFilterFooter({ onReset, onApply }: CommunityFilterFooterProps) {
  return (
    <div className="flex gap-3 border-t border-gray-50 bg-gray-50/50 p-5">
      ...
      <button
        onClick={onApply}
        className="h-12 flex-1 rounded-xl bg-[var(--color-primary-600)] text-sm font-bold text-white shadow-lg shadow-gray-200 transition-colors hover:bg-[var(--color-primary-700)]"
      >
        필터 적용하기
      </button>
    </div>
